    ...
    <footer className="bg-espresso-900 text-ivory-100/70 py-16 mt-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          ...
          {/* Logo + Slogan + Social — Mobile pe puri width */}
          ...
          {/* Quick Links + Products — Mobile pe side by side */}
          ...
          {/* Contact — Mobile pe puri width */}
          <div className="sm:col-span-2 md:col-span-1">
            <h4 className="font-cinzel text-white mb-4">Contact</h4>
            <div className="text-sm space-y-2">
              <p>Village Lathwan, P.O. Ladraur, Tehsil Bhoranj, Distt Hamirpur, Himachal Pradesh-176043</p>
              <p>+91 94595-6140, 96254-52835</p>
              <p>deyalfoodproducts@gmail.com</p>
            </div>
          </div>
